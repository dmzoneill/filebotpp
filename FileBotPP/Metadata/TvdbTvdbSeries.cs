...
{
    public class TvdbSeries : ITvdbSeries
    {
        private readonly List< ITvdbSeason > _seasons;
        private string _actors;
        private string _genre;

        public TvdbSeries( string series )
        {
            this.SeriesName = series;
            this._seasons = new List< ITvdbSeason >();
        }
        ...
        public List< ITvdbSeason > get_seasons()
        {
        ...
        public ITvdbSeason get_season( int num )
        {
            ...
            var newseason = new TvdbSeason( num );
